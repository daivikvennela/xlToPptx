...
def add_modal_creation():
    """Add modal creation before button creation"""
    
    # Read the file
    with open('templates/index.html', 'r') as f:
        content = f.read()
    
    # Define the modal creation code
    modal_code = '''
            // Create Exhibit A modal immediately before button creation
...
'''
    ...
    # Find the button creation line
    button_line = "            // Add Generate Exhibit A button"
    pos = content.find(button_line)
    
    if pos != -1:
        # Insert modal creation before button creation
        new_content = content[:pos] + modal_code + content[pos:]
        ...
        print("Could not find button creation line")
        return False
